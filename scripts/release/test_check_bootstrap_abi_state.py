...
class BootstrapABIStateTest(unittest.TestCase):
    ...
    def test_accepts_recovery_0_1_7_abi_1_2_state(self) -> None:
        result = self.run_checker(
    ...
    def test_accepts_0_2_0_dev_abi_1_3_source_state(self) -> None:
        result = self.run_checker(
        ...
        self.assertEqual(result.returncode, 0, result)
        self.assertIn(
            "bootstrap ABI state ok: version 0.2.0-dev, abi 0x00010003",
            result.stdout,
        )
